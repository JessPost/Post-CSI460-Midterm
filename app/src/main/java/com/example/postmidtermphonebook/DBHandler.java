...
public class DBHandler extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "myphonebook";
    ...
    // below variable id for our last name column.
    ...
    public void addNewContact(String fName, String lName, String phoneNum, String address) {
    ...
    public void updateContact(String originalFName, String firstName, String lastName,
        ...
        db.update(TABLE_NAME, values, "fname=?", new String[]{originalFName});
        db.close();
    }
